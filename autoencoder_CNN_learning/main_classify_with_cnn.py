...
class ClassifyController(object):
    ...
    def get_result(self):
        _res = [self.class_label_list.count(0),
                ...
                self.class_label_list.count(3),
                self.class_label_list.count(4),
                self.class_label_list.count(5),
                self.class_label_list.count(6),
                self.class_label_list.count(7),
                self.class_label_list.count(8),
                self.class_label_list.count(9)
                ]
...
if __name__ == '__main__':
    ...
    while True:
        ...
        # omni_base.go_abs(start_position[0], start_position[1], start_position[2], 100) #start point
        # hand_down
        ...
        print('It is '+object_list[object_label])
        tts.say(object_list[object_label])
